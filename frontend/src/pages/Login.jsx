    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="website-container grid min-h-[calc(100vh-160px)] items-center gap-10 py-12 lg:grid-cols-[1fr_460px]">
        ...
        <form onSubmit={submit} className="card p-6">
          ...
          <label className="mt-4 block text-sm font-bold">Password<input className="field mt-2" type="password" value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} required /></label>
